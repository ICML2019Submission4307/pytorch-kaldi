...
from binarized_modules import BinarizeLinear, QuantizeLinear, Quantize, QuantizeVar
    ...
    def forward(self, x):
        ...
        for i in range(self.N_lstm_lay):
            ...
            if self.final_quant and self.lstm_quant:
                # self.wfx[i].weight.data = Quantize(self.wfx[i].weight.data, numBits=self.param_quant[i])
                # self.wix[i].weight.data = Quantize(self.wix[i].weight.data, numBits=self.param_quant[i])
                # self.wox[i].weight.data = Quantize(self.wox[i].weight.data, numBits=self.param_quant[i])
                # self.wcx[i].weight.data = Quantize(self.wcx[i].weight.data, numBits=self.param_quant[i])
                # wfx_data = QuantizeVar(self.wfx[i].weight.data, numBits=self.param_quant[i])
                # wix_data = QuantizeVar(self.wix[i].weight.data, numBits=self.param_quant[i])
                # wox_data = QuantizeVar(self.wox[i].weight.data, numBits=self.param_quant[i])
                # wcx_data = QuantizeVar(self.wcx[i].weight.data, numBits=self.param_quant[i])
                ...
                # save_cgs_mat.save_mat(self.wfx[i].weight.data, str(i) + '_wfx_q', self.param_sav)
                # save_cgs_mat.save_mat(self.wix[i].weight.data, str(i) + '_wix_q', self.param_sav)
                # save_cgs_mat.save_mat(self.wox[i].weight.data, str(i) + '_wox_q', self.param_sav)
                # save_cgs_mat.save_mat(self.wcx[i].weight.data, str(i) + '_wcx_q', self.param_sav)
            ...
            if self.final_quant and self.lstm_quant:
                # self.ufh[i].weight.data = Quantize(self.ufh[i].weight.data, numBits=self.param_quant[i])
                # self.uih[i].weight.data = Quantize(self.uih[i].weight.data, numBits=self.param_quant[i])
                # self.uoh[i].weight.data = Quantize(self.uoh[i].weight.data, numBits=self.param_quant[i])
                # self.uch[i].weight.data = Quantize(self.uch[i].weight.data, numBits=self.param_quant[i])
                # ufh_data = QuantizeVar(self.ufh[i].weight.data, numBits=self.param_quant[i])
                # uih_data = QuantizeVar(self.uih[i].weight.data, numBits=self.param_quant[i])
                # uoh_data = QuantizeVar(self.uoh[i].weight.data, numBits=self.param_quant[i])
                # uch_data = QuantizeVar(self.uch[i].weight.data, numBits=self.param_quant[i])
                ...
                # save_cgs_mat.save_mat(self.ufh[i].weight.data, str(i) + '_wfh_q', self.param_sav)
                # save_cgs_mat.save_mat(self.uih[i].weight.data, str(i) + '_wih_q', self.param_sav)
                # save_cgs_mat.save_mat(self.uoh[i].weight.data, str(i) + '_woh_q', self.param_sav)
                # save_cgs_mat.save_mat(self.uch[i].weight.data, str(i) + '_wch_q', self.param_sav)
